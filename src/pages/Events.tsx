        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 max-w-md mx-auto">All current events have passed their registration deadlines. Check back soon!</p>
            </div>
          ) : (
                        ...
                        <div className="flex-1">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2">
                              {event.event_type && (
                                <span className="inline-block bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">{event.event_type}</span>
                              )}
                          ...
                          <div className="flex flex-wrap gap-4 text-sm text-gray-500 mb-3">
                            {event.time && <div className="flex items-center"><Clock className="h-4 w-4 mr-2" />{event.time}</div>}
                            {event.location && <div className="flex items-center"><MapPin className="h-4 w-4 mr-2" />{event.location}</div>}
                            {event.attendees && <div className="flex items-center"><Users className="h-4 w-4 mr-2" />{event.attendees} attending</div>}
                          </div>
                          {event.registration_deadline && (
                            <div className="text-xs text-gray-500">Registration deadline: {formatDeadlineDate(event.registration_deadline)}</div>
                          )}
                        </div>
                        <div className="flex-shrink-0">
                          <button
