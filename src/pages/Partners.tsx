      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-12 transition-all duration-1000 transform ${
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We are proud to work with these amazing organizations who share our passion for adventure and exploration.
          </p>
        </div>
            ...
            <div className="overflow-hidden">
              ...
              >
                {partners.map((partner) => (
                  <div
                    key={partner.id}
                    className={`flex-shrink-0 px-4 transition-all duration-1000 transform ${
                      isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                    }`}
                  ...
                  >
                    ...
                    {partner.website_url && (
                      <a
                        ...
                        className="block text-center text-xs text-gray-400 mt-2 hover:text-green-600 truncate"
                      >
                        {partner.name}
                      </a>
                    )}
